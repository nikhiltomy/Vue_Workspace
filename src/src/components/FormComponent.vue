<template>
    ...
    <div class="form-group">
      ...
      <input class="form-control" id="add-name" v-model="enteredTitle"  />
    </div>
    <div class="form-group">
      <label for="add-description" class="add-name">genre</label>
      <input class="form-control" id="add-description" rows="10" v-model="enteredGenre" />
    </div>
    <div class="form-group">
      <label for="add-price" class="add-name">path <span class="glyphicon glyphicon-euro"></span></label>
      <input type="text" class="form-control" id="add-price" v-model="enteredPath" />
    </div>
